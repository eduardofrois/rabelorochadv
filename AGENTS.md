...
This project is indexed by GitNexus as **rabelorochadv** (171 symbols, 157 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
