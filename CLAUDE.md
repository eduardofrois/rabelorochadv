...
This project is indexed by GitNexus as **rabelorochadv** (99 symbols, 95 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
